...
from config.emoji import C_DUMPLINGS, FRENCH_FRIES,MONEY_PAPER
...
marriage_options = [  # ["類別名","類別 SQL","emoji","英文",親密度下限,親密度上限,金錢花費]
    ...
    ["餐廳 - ", "restaurant", "🍢",             "鳥馬",                     "molecular",            -15, 20, 2388,  timedelta(days=3)],
    ["餐廳 - ", "restaurant", "🥘",             "牛爸爸羊肉爐",             "lamb stove",            10, 25, 2772,  timedelta(days=3)],
    ["餐廳 - ", "restaurant", "🥩",             "教皇牛排",                 "s_steak",              -20, 40, 3330,  timedelta(days=3)],
    ["餐廳 - ", "restaurant", "🍧",             "分子料理",                 "molecular",             20, 30, 4200,   timedelta(days=3)],
    ["其他 - ", "other", "💎",                  "1克拉鑽石",                "diamond",               50, 100, 88888]
]
...
RELATION_LIMIT = [100, 500,9999999]
